...
#FOF_PRIMARY_LINK_TYPES=2+4+8+16+32           # 2^type for the primary dark matter type
...
#AB_SHOCK=0.85                  # Shock- and Machfinder
#AB_SHOCK_SHOCKFLAG=0.40        # Mark particles that clearly belong to a shock front
#AB_SHOCK_SPEEDUP=0.01          # Shockflag calculation only depends on a mach number criteron for faster execution
#AB_SHOCK_MAGNETIC              # Account for Alfvenwaves in signal velocity
#AB_SHOCK_EXPANSION=1.0         # Account for expansion of space in signal velocity
#AB_SHOCK_CORRECTION=1.045      # Correction factor for mach number
